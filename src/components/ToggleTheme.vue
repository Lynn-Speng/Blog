<template>
  <!--prettier-ignore-->
  <button role="button" aria-label="Toggle dark/light" @click.prevent="toggleTheme" class="focus:outline-none hover:opacity-80 bg-transparent text-gray-800 dark:text-gray-200 cursor-pointer">
